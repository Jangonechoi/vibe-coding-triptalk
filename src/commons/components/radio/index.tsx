    ...
    return (
      ...
      >
        <input
          ...
          {...props}
        />
        <label htmlFor={radioId} className={styles.radio__label}>
          <span className={styles.radio__icon}>
            <svg
              className={styles.radio__icon__enabled}
            ...
            <svg
              className={styles.radio__icon__selected}
              width={size === "small" ? "20" : "24"}
              height={size === "small" ? "20" : "24"}
              viewBox="0 0 24 24"
              fill="none"
          ...
          {labelText && <span className={styles.radio__text}>{labelText}</span>}
        </label>
      </div>
    );
  }
